...
const INDEFINITE = { en: 'No article: an unspecified amount.', ru: 'Без артикля — продукт вообще, не какое-то количество.' };
...
export const RULE: DialogueRule = {
	...
	summary: { en: 'Three distances of “this”. 40 seconds.', ru: 'Три «расстояния» слова «этот». 40 секунд.' },
	intro: {
	...
	examples: [
		{ armenian: 'այս հացը', translation: { en: 'this bread', ru: 'этот хлеб' }, hint: { en: 'by me', ru: 'у меня' } },
		{ armenian: 'այդ հացը', translation: { en: 'that bread', ru: 'тот хлеб' }, hint: { en: 'by you', ru: 'у Вас' } },
		{ armenian: 'այն հացը', translation: { en: 'that bread', ru: 'тот хлеб' }, hint: { en: 'over there', ru: 'вон там' } }
	],
	outro: {
...
export const LINES: readonly DialogueLine[] = [
	{
		...
		tokens: [
			tok('Բարև', 'barev', { en: 'hello', ru: 'здравствуйте' }, {
	...
	},
	{
		...
		tokens: [
			...
			tok('կա՞թը,', 'kat', { en: 'the milk', ru: 'молоко (это)' }, {
			...
			tok('կաթը։', 'kat', { en: 'the milk', ru: 'молоко (то)' }, {
	...
	},
	{
		...
		tokens: [
			...
			tok('խնդրում', 'khndrel', { en: 'please', ru: 'пожалуйста' }, {
	...
	},
	{
		...
		tokens: [
			...
			tok('լավն', 'lav', { en: 'good', ru: 'хорошая' }, {
	...
	},
	{
		...
		tokens: [
			tok('Սուրճ։', 'surch', { en: 'coffee', ru: 'кофе' }, {
	...
	},
	{
		...
		tokens: [
			tok('Ուրիշ', 'urish', { en: 'other', ru: 'другое' }, {
